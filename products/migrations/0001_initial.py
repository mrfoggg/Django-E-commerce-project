    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parameters', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, verbose_name='Характеристики товара')),
                ('parameters_structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, verbose_name='Структура характеристик')),
                ('sorted_parameters_structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=list, verbose_name='Сортированная структура характеристик')),
                ('custom_order_group', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=list, verbose_name='Индивидуальный порядок групп атрибутов для сочетания категорий')),
                ...
                ('shot_parameters_structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, verbose_name='Структура кратких характеристик товара')),
                ('mini_parameters_structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, verbose_name='Структура мини характеристик товара')),
                ('shot_parameters_custom_structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, verbose_name='Структура кратких характеристик товара для сочетания категорий')),
                ('mini_parameters_custom_structure', django.contrib.postgres.fields.jsonb.JSONField(blank=True, default=dict, verbose_name='Структура мини характеристик товара для сочетания категорий')),
                ...
                ('category_collection', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.CategoryCollection', verbose_name='Коллекция категорий')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, db_index=True, default=None, max_length=128, null=True, unique=True, verbose_name='Название для кратких характеристик (оставить пустым если названиие атрибута желаете оставить тем же)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, db_index=True, default=None, max_length=128, null=True, unique=True, verbose_name='Название для мини характеристик (оставить пустым если названиие атрибута желаете оставить тем же)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position_product', models.PositiveIntegerField(default=0, verbose_name='PositionProduct')),
